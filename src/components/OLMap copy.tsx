...
const OpenLayerMap: React.FC<OpenLayerMapProps> = ({ center, zoom, markers }) => {
...
function rotateTriangleAroundApex(apex: [number, number], baseWidth: number, height: number, angle: number): number[][] {
